...
namespace Yoo.Trainees.ShipWars.Api.Test
{
    public class VerificationLogicTest
    {
        ...
        public void TestVerifyCorrectFilledList_ShouldReturnTrue()
        {
            ...
            var shipDtos = new SaveShipDto[]
            {
                new SaveShipDto{Direction = "vertical", X = 1, Y = 0, ShipType = "Warship"},
                new SaveShipDto{Direction = "horizontal", X = 4, Y = 1, ShipType = "Cruiser"},
                new SaveShipDto{Direction = "vertical", X = 6, Y = 4, ShipType = "Cruiser"},
                new SaveShipDto{Direction = "vertical", X = 3, Y = 3, ShipType = "Destroyer"},
                new SaveShipDto{Direction = "horizontal", X = 8, Y = 3, ShipType = "Destroyer"},
                new SaveShipDto{Direction = "horizontal", X = 3, Y = 6, ShipType = "Destroyer"},
                new SaveShipDto{Direction = "vertical", X = 1, Y = 8, ShipType = "Submarine"},
                new SaveShipDto{Direction = "vertical", X = 4, Y = 8, ShipType = "Submarine"},
                new SaveShipDto{Direction = "horizontal", X = 8, Y = 7, ShipType = "Submarine"},
                new SaveShipDto{Direction = "horizontal", X = 6, Y = 9, ShipType = "Submarine"}
            };
        ...
        public void TestVerifyeOutOfBound_ShouldReturnFalse()
        {
            ...
            var shipDtos = new SaveShipDto[]
            {
                ...
                new SaveShipDto{Direction = "horizontal", X = 4, Y = 12, ShipType = "Submarine"}
            };
        ...
        public void TestVerifyeToManyShipsFromSameType_ShouldReturnFalse()
        {
            ...
            var shipDtos = new SaveShipDto[]
            {
                ...
                new SaveShipDto{Direction = "horizontal", X = 0, Y = 0, ShipType = "Destroyer"},
                new SaveShipDto{Direction = "horizontal", X = 7, Y = 4, ShipType = "Destroyer"},
                new SaveShipDto{Direction = "horizontal", X = 1, Y = 8, ShipType = "Submarine"},
                new SaveShipDto{Direction = "horizontal", X = 6, Y = 0, ShipType = "Submarine"},
                new SaveShipDto{Direction = "horizontal", X = 1, Y = 5, ShipType = "Submarine"},
                new SaveShipDto{Direction = "horizontal", X = 7, Y = 8, ShipType = "Submarine"},
        ...
        public void TestVerifyeUnkownDirection_ShouldReturnFalse()
        {
            ...
            var shipDtos = new SaveShipDto[]
            {
                ...
                new SaveShipDto{Direction = "horizontal", X = 1, Y = 5, ShipType = "Submarine"},
                new SaveShipDto{Direction = "horizontal", X = 7, Y = 8, ShipType = "Submarine"},
                new SaveShipDto{Direction = "Unkown", X = 4, Y = 9, ShipType = "Submarine"}
            };
